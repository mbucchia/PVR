...
{
	m_adapterId.HighPart = m_adapterId.LowPart = 0;
}
...
void DeviceResources::CreateDeviceResources()
{
    ...
    GetHardwareAdapter(m_adapterId, adapter.GetAddressOf());
...
void DeviceResources::GetHardwareAdapter(LUID adapterId, IDXGIAdapter1** ppAdapter)
{
    *ppAdapter = nullptr;
...
#endif
		if ((m_adapterId.HighPart == 0 && m_adapterId.LowPart == 0)
			|| (memcmp(&desc.AdapterLuid, &adapterId, sizeof(LUID)) == 0)) {
			break;
		}
    }
